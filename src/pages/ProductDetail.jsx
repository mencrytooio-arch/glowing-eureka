          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="flex flex-col justify-center space-y-8">
                {/* Product Name */}
                <h1 className="text-3xl sm:text-4xl font-light tracking-tight text-brand-primary">
                  {product.name}
                </h1>
                ...
                <div className="space-y-4 pt-4">
                  <label className="block text-sm font-light text-brand-primary tracking-wide uppercase">
                    Size
                  </label>
                  <div className="grid grid-cols-6 gap-3">
                    {sizes.map((size) => (
                      <button
                        key={size}
                        className="py-3 px-4 border border-brand-secondary/30 text-brand-primary font-light hover:border-brand-primary hover:bg-brand-light transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2"
                      >
                        {size}
                      </button>
                    ))}
